...
import { ReactComponent as Icon3 } from "../assets/svgs/services/Chatbots.svg";
    ...
    <>
      ...
      <section className="h-screen banner relative text-white">
        <div className="absolute top-0 w-full h-full bg-black/30">
          {/* bg-gradient-to-b from-background/10 via-background/10 to-background/10 */}
          <div
            data-aos="fade-up"
          ...
          >
            ...
            <p className="sub-heading max-w-6xl !text-white">
              Brainways Tech is your one-stop destination for innovative digital
              solutions. With our expertise and dedication, we offer a range of
              services designed to elevate your online presence and drive
              success.
            </p>
          </div>
        </div>
      ...
      >
        <div className="bg-gray-500 rounded-lg backdrop-blur-sm text-background p-5">
        ...
        <div className="bg-gray-500 rounded-lg backdrop-blur-sm text-background p-5">
          ...
          <p className="desc">
            Enhance customer interactions with our intelligent chatbots,
            automating tasks and boosting efficiency in support and lead
            generation.
          </p>
        </div>
      </div>
